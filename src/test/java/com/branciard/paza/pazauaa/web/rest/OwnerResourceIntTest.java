...
import com.branciard.paza.pazauaa.repository.OwnerRepository;
...
public class OwnerResourceIntTest {
    ...
    public void createOwner() throws Exception {
        ...
        assertThat(testOwner.getEcert()).isEqualTo(DEFAULT_ECERT);
    }
    ...
    public void getAllOwners() throws Exception {
        ...
        restOwnerMockMvc.perform(get("/api/owners?sort=id,desc"))
                ...
                .andExpect(jsonPath("$.[*].ecert").value(hasItem(DEFAULT_ECERT.toString())));
    }
    ...
    public void getOwner() throws Exception {
        ...
        restOwnerMockMvc.perform(get("/api/owners/{id}", owner.getId()))
            ...
            .andExpect(jsonPath("$.ecert").value(DEFAULT_ECERT.toString()));
    }
    ...
    public void updateOwner() throws Exception {
        ...
        Owner testOwner = owners.get(owners.size() - 1);
        assertThat(testOwner.getEcert()).isEqualTo(UPDATED_ECERT);
    }
